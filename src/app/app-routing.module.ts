...
const routes: Routes = [
  ...
  {
    path: 'singleton',
    loadChildren: () => import('./03. Singleton/singleton.module').then(m => m.SingletonModule)
  },
  {
    path: 'prototype',
    loadChildren: () => import('./04. Prototype/prototype.module').then(m => m.PrototypeModule)
  },
  // {
  //   path: 'builder',
  ...
  {
    path: 'factory-method',
    loadChildren: () => import('./02. Factory Method/factory-method.module').then(m => m.FactoryMethodModule)
  },
  {
    path: 'adapter',
    loadChildren: () => import('./05. Adapter/adapter.module').then(m => m.AdapterModule)
  },
  // {
  //   path: 'facade',
  ...
  {
    path: 'decorator',
    loadChildren: () => import('./06.Decorator/decorator.module').then(m => m.DecoratorModule)
  },
  // {
  //   path: 'proxy',
  ...
  // { path: 'mediator', loadChildren: () => import('./13. Mediator/mediator.module').then(m => m.MediatorModule) },
   {
    path: 'iterator',
    loadChildren: () => import('./07. Iterator/iterator.module').then(m => m.IteratorModule)
  },
  // {
  //   path: 'memento',
  ...
  {
    path: 'state',
    loadChildren: () => import('./08. State/state.module').then(m => m.StateModule)
  },
  // {
